# -*- coding: utf-8 -*-
"""Classification Report:best_models.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1b4tQgT8Wm6YZwWc_jHCzMTP3YVEFN3Ke
"""
...
"""# Код для обучения CatBoost

В данном разделе предствлен код для обучения и демонстрация результатов лучшей обученной модели CatBoost на тестовых данных
"""
...
"""# Загрузка лучшей обученной модели классического машинного обучения и демонстрация результатов на тестовых данных"""

file_id = "1kgUVni4IO3dxBHX5HLNj8wXAVxBH5k2I"
url = f"https://drive.google.com/uc?id={file_id}"

gdown.download(url, "catboost_model.cbm", quiet=False)
...
"""Важность признаков и матрица ошибок для лучшей модели CatBoost:"""
...
# Загрузка лучшей обученной нейросетевой модели для одномерных данных и демонстрация результатов на тестовых данных
